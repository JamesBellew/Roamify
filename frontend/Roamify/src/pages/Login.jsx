...
const Login = () => {
    ...
    return (
     <>
        ...
        <h1 className="text-3xl font-medium text-center dark:text-white">Welcome to Roamify</h1>
...
<div className="py-4">        <h3 className='text-center text-text-secondary'>Sign in with one of the below</h3>
 ...
 <div className="py-3 flex flex-col gap-3">
    ...
    <button onClick={GoogleLogin} className="bg-purple-main/30 text-white p-5 flex align-middle rounded-xl m-2 mt-4 gap-5 mx-auto"><FcGoogle className="text-2xl  "/>Sign in with Google</button>
    <button  className="bg-purple-main/30 text-white p-5 flex align-middle rounded-xl m-2 mt-4 gap-5 mx-auto"><AiFillFacebook className="text-2xl text-facebook  "/>Sign in with Facebook</button>
...
<button onClick={GuestLoginHandler}  className="bg-pink-main text-white p-5 flex align-middle rounded-xl m-2 mt-4 gap-5 mx-auto"><FaUserAlt className='text-2xl'/> Continue as Guest</button>
</div>
     </>
    );
};
